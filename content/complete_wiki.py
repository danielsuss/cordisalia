...
## Overview
### Part 1
introduction, the stonemancer and his smith
their adventures
ends with stonemancer slashing down enemies, the smith collecting stones and smithing texts

### Part 2
stonemancer and smith taking on an important quest
ending in their wide recognition and the smith having a son

### Part 2
the stonemancer takes the son on as an apprentice
trains him
curious, the smith embues a lodestone in his son, rather than in a tool
corrupts his son

### Part 3
the stonemancer tries to rescue his apprentice, but won’t kill him, ends up getting backstabbed and killed by his apprentice
smith disappears

## Plot
### Act 1 - Beginnings
*orphanage, young smith and stonemancer playing together with a wooden sword and hammer*
- stonemancer and smith grew up together orphans, would always watch adventurers travelling through
- stonemancer dreamed of becoming a hero, smith dreamed of forging great weapons
*path through the woods, teen smith and stonemancer with backpacks travelling*
- eventually they left the orphanage, started doing small quests together, stonemancer doing any fighting, smith carrying and dealing with loot
*cave,stonemancer and smith looking down blue glow, smith holding blue lightning lodestone in his hand*
- eventually one of there rewards was an old stone, one the smith seemed to have read about in an ancient smithing text - a lodestone
- stonemancer would follow the ancient text - one of the arcane smith - and embue the stonemancer’s blade with the stone - blue flash
- fast forward - the stonemancer slashing through hordes of bandits with blue lightning flashes
- the smith collecting lode stones and ancient smithing texts

- story begins in a humble orphanage, where two boys inseperable at the waist
- as they'd sneak out of the orphanage to hear stories of travelling adventurers, their dreams grew
- byron, dreamed of becoming a hero, and rhoald, dreamed of forging great weapons, both yearning for adventure
- eventually, they grew enough to leave the orphanage, starting their own adventure
- they travelled, getting by as they could, doing what small quests they could manage
- if in danger, the combination of byron with his sword and rhoald with his tinker's mind they'd always manage to scrape by
- one day, on a quest to quell a group of kobolds from a nearby cave, rhoald would find something, something he'd read about in ancient smithing texts he'd manage to sneak out of various libraries
- a round stone, with a glowing runic inscription, a lodestone
- mystic powers were rumoured to emerge from these stones, and many of the smithing texts speculated that weapons could be imbued with these powers if the stones were forged with correctly, however from what rhoald had seen, none had managed the feat
- fast forward a few years spent continuing adventuring with byron and honing his smithing craft as well as his natural talent, rhoald managed the feat, empowering his dear friend with a tier of weapon that none before had wielded. along his adventures he'd collected lodestones from where he could, although they proved very rare. and so, rhoald became the first arcane smith, and byron the first stonemancer

### Act 1
Before the modern commonplace of arcane smiths and lodestones, In Pyraust's Domain, lays a town, Greyhollow, home to an Orphanage. It was here that two boys, inseparable at the waist, dreamed of adventure.

Byron was the dreamer—tall for his age, with eyes that sparkled whenever tales of heroism filled the evening air. His friend Rhoald was quieter, his calloused hands always tinkering with broken trinkets, coaxing life back into discarded metal and wood. Where Byron saw grand quests and noble deeds, Rhoald saw the intricate mechanisms that made such wonders possible.
...
When they finally came of age and left Greyhollow behind, they set out with nothing but Byron's inherited sword, Rhoald's makeshift collection of tools, and hearts full of ambition. The road was harder than the tavern tales had suggested. They took whatever work they could find—clearing rats from cellars, delivering messages through dangerous territory, standing guard over merchant caravans.
...
Byron, ever loyal, supported his friend's obsession even when it meant eating cold meals and sleeping under stars while Rhoald worked late into the night at makeshift forges. More lodestones were discovered in their travels—always rare, always precious—and each one taught Rhoald something new about their nature.

Then came the night when everything changed. Deep in the heart of a dwarven forge in the Burning Expanse that Rhoald had convinced the master smith to let him use, the impossible finally happened. As he brought his hammer down one final time, the lodestone didn't shatter—it merged. The blade seemed to drink in the stone's light, and suddenly Byron's simple sword hummed with a warmth that made the air around it warp.

Rhoald had become the first arcane smith. And Byron, wielding that first enchanted blade, had become something new entirely—the first stonemancer, a warrior whose weapon was an extension of magic.
...
###### Act 1
Before the modern commonplace of arcane smiths and lodestones, In Pyraust's Domain, lays a town, Greyhollow, home to an Orphanage.
![[orphanage.png]]
It was here that two boys, inseparable at the waist, dreamed of adventure.
![[orphans.png]]
Byron was the dreamer—tall for his age, with eyes that sparkled whenever tales of heroism filled the evening air. His friend Rhoald was quieter, his calloused hands always tinkering with broken trinkets, coaxing life back into discarded metal and wood. Where Byron saw grand quests and noble deeds, Rhoald saw the intricate mechanisms that made such wonders possible.
...
It was during what should have been a simple quest—clearing a family of kobolds from a cave that had been terrorizing local farmers—that everything changed.
![[cave.png]]
As Byron fought off the snarling creatures with skill born of necessity, Rhoald's keen eyes spotted something glinting in the depths of the cave.
...
Byron, ever loyal, supported his friend's obsession even when it meant eating cold meals and sleeping under stars while Rhoald worked late into the night at makeshift forges. Then came the night when everything changed. Deep in the heart of a dwarven forge in the Burning Expanse that Rhoald had convinced the master smith to let him use, the impossible finally happened. 
![[dwarvenforge.png]]
As he brought his hammer down one final time, the lodestone didn't shatter—it merged. The blade seemed to drink in the stone's light, and suddenly Byron's simple sword hummed with a warmth that made the air around it warp.
...
- as they approach, they hear one of the armoured men announce "only those who have been deemed worthy may enter [[Florion's Sanctum]]"
...
- as they are looking at the village, they hear something coming from behind them, and suddenly a pure white dragon is over head, flying towards [[Wyrmsgard]]

### Opener
- they see the white dragon flying to wyrmsgard
- they see the glint of a helmet of someone riding atop the dragon in the sunlight
- the dragon flies into wyrmsgard past what they can see
- liri flies up in the air and looks back and forth between where the dragon was and the gang
- gobsmacked she remarks about the fact that there was someone riding the dragon
- see amara smiling, looking up towards the cliff with intent, she expresses that they have to get to the top of the cliff

##### Chapter 10
- Recap
- Arriving in Wyrmsgard
- Greeted by Murlin
- Murlin backstory
- Murlin tells them no time for idle chit chat Brogan's got a ship to catch
- Fast forward, take a dragon lift down to wyvern's port in the north of the city
- as brogan's getting on his ship, there is another ship docked
- they see a man carrying cargo off of the ship, boxes of musical instruments in fact
- one of the boxes has trumpets in it - opportunity for ysgarlad to buy a trumpet
- wave brogan off into the distance, as the sun is setting
- Murlin takes them back to the inn where he is staying - Lythorax's roost
- as they are walking along the streets, one of them gets approached by a homeless little boy, with brown gloves, clearly given to him by his mother, begging for money, pointing at his mother,
- They approach the bar, Evie greets murlin and the rest
- Interrupted by Lysander walking over
- "Prince Highvale, what do you want can't you see im busy"
- "Evie how many times do I have to tell you not to call me that, yes you are correct, that is my last name, but i'd rather be judged by my own actions than some letters given to me at birth - anyway, more importantly, i think i've got it figured out"
- "Lysander i don't have time right now for your stupid recent obsession with the veilstalker, can't you see i've got customers" shoes him away
- he looks annoyed and walks back to his table kicking dust with more drinks and gets back to yapping
- Evie tells of the tale of the veilstalker, and how people have been disappearing recently, beggars, streetfolk the like, it's a shame but no one seems to care about what happens to them
- people like lysander over there have begun speculating its the spirit of the veilstalker
- stay the night at the inn - murlin tells them of his job
****
- on the way out of wyrmsgard to the cragneedle woods, the gang walks past where they saw the homeless boy, now just a brown glove
- in [[Cragneedle Woods]] looking for bugbears
- liri turns into familiar cat - one from rorkard - the tip of the tail is purple
- says she'll detect any new scent that comes up and starts sniffing and walking through the forest
- liri eventually smells something
- starts dashing in that direction
- turns out to be mugwort's cooking
- liri says "it smells so goood, please let me have some, you can have half of our earnings from the quest we are on if you let me have some"
- hear a rumbling
- bugbear group enters 
- smelling the cooking
*BUGBEAR FIGHT*
- go back to town with stuff, go drop stuff off with crausse in the wyrms shadow
- crausse pauses for a moment, slightly in shock
- goes straight back to normal
- if you's are keen for another job, i'd gladly pay for your help
- etc. etc.
##### Torbert's general
- Starts with wee gwyndaff
- torbert shoos him away to his mother
- tells them the story of what happened to wee gwyndaff
- anyway asks them if they want to buy anything
- moves on to his book section
- The Rise of Wyrmsgard
- Tale of the Stonemancer
- Secrets of Alladaroth
- magic - they'll have to go to the drakenspire conservatory
- 
...
##### Landscapes
- [x] wyrmsgard
- [x] forest outside wyrmsgard
- [x] forest with campfire
- [x] wyrmsgard docks
- [x] lythorax's roost
- [x] wyrm's shadow
- [x] torbert's general
...
##### Battlemaps
- [x] battle with bugbears in forest

##### Items

###### Todo
- [ ] Dragon Daughter name
- [ ] prince highvale name
- [ ] wyrms docks
- [ ] update verdant continent map?
- [ ] murlin intro
- [ ] trio of books
- [ ] bugbear statblock
...
### Murlin Backstory
You've always known, deep in your bones, that you are a true wizard. How could you not be? You were born into the illustrious Stone-Flask family, seven generations of magicians whose magic has benefited the settlements of the Burning Expanse since the Great Coalescence. The arcane flows through your veins just as surely as blood.
...
### The Veilstalker - Evie
My grandmother used to frighten us with tales of the Veilstalker when I was small. Said that centuries ago, a dragon rider was wrongfully accused by the Drakenspire Council of selling our secrets to outsiders. When he wouldn't confess to their lies, they murdered his dragon, Morothrax, while he watched, helpless.

As they struck him down, he spat a curse with his final breath—he'd return through mist and shadow to hunt down his betrayers' bloodlines until none remained.

Granny always told us that when fog clings thick to the mountain and you smell burning amber on the air, you should scurry home and lock your doors tight. The old folk claim dragon scales worn 'round your neck might protect you from his touch. But mark my words—if you hear that eerie dragon-song whistle in the dark, and you've got betrayer's blood in your veins... well, no trinket will save you then.
...
- opener, from where they left off, in lythorax's roost, in the evening, just having discussed all that they learned from last time
### Plot - Lysander's Gift
- when in lythorax's roost, gang sees lysander with a group of friends again
- overhear the group singing happy brithday, to a man with his back to the group, a man with short black hair, that wyatt recognises, but for some reason, his memory mind seems clouded when trying to remember who it is
- after they finish singing happy birthday, lysander, who is next to the man, hands him a gift
- the man takes the gift out of its pouch, a charm, with a deep emerald green dragon scale on the end
- the man clearly thanks lysander for the gift, showing his appretiation, holds it up to let it shine in the light, before tucking it away somewhere
- wyatt can't scratch the fact that he recognises the hair, but can't tell where from
- if wyatt approaches him, aggravated, lysander and their group of friends get in the middle, 
- lyle says, really guys no need to get in a fight for me, i've gotta go anyway, it's already dusk
- wyatt, and mugwort if he's in hearing range, both feel their heart beat intensely, before falling to their knees in a wave of nausea
### Cutscene - Amara's Letter
- in the evening
_Dear Ysgarlad, Woo, and Liri,_

_I've decided to leave Wyrmsgard to find my own path. Spending time with the dragon riders today showed me that I need to learn self-sufficiency and strengthen the bond with my wolves properly._

_Thank you for everything—you saved more than just my life. I hope our paths cross again someday when I'm stronger._

_With gratitude,_

_Amara_

_P.S. - I left something small with Evie as thanks._
- as they finish reading the letter, they smell the faint smell of burning amber, and a quiet whistle, as they look out the window, they see a thick mist fill the streets below

### Plot - General Stuff Next Day Planning Etc.
- at some point see lysander in the middle of the town pleading with a man
- please father "there was another attack last night, we have the chance to do something yet we sit in silence"
	- lord highvale "Lysander, I don't have the time for such idiotics, you know the annual ball is soon approaching, i'd hope that you soon start spending your time practicing making a good first impression with the rest of the people who will be in attendance rather than making a fool out of yourself spreading rumours"
### Plot - Catching the Veilstalker
- setup in the night, see the mist rolling into the town
- see a shadowy figure moving through the mist
- at some point mist passes over a homeless person, next moment homeless person is gone
- chasing the mist figure - lyle
- eventually corner them
- fight ensues
- after he has been cornered, takes homeless person hostage, if attacked, slashes homeless person's throat, whoever is closest to him, giant mist figure pops out of the mist and shoulder barges them at breakneck speed
- takes lyle and jumps to the roofs and away into the mist
- homeless person is left, and lyle's pouch in their hand, that they grabbed off of him
- lysander catches up, after the whole thing, recognises the pouch, realises it was lyle

### Plot - Noble Family Infiltration

### Plot - Drakenspire Conservatory

### Plot Blood Hunter
**"We have been watching you, little lamb. We see how you clutch your chest when sleep eludes you. We know of the hunger that gnaws beneath your ribs, the way your pulse quickens when you smell iron on the wind."**

_Images flash unbidden through your mind—your own reflection, but the eyes are not your own. They are ancient, predatory, knowing._

**"You feel it stirring, don't you? That delicious darkness coiling in your veins like serpents of liquid night. The whispers that come when you bleed, promising such sweet, terrible secrets..."**

_Your heartbeat becomes a thunderous drum as shadowy tendrils seem to caress the inside of your skull._

**"We are the Sanguine Collective, and your blood has been singing our song since birth. The crimson threads that bind all life have led us to you, as they always do. As they must."**

_Pain lances through your temples as visions of ritual chambers and crimson altars flood your consciousness._
### Plot - Bread Crumbs to Haldor

### Plot - Mugwort sets up his stall
- needs to have bought ingredients and fuel first
- torbert heads over with wee gwyndaff
- asks if they can run the stall together - we gwyndaff’s got a new recipe
- recipe is gross when mugwort tries it
- “geyndaff these are absolute dookieshite, they tasted good this morning”
### Cutscene - Shacklehold
- Willbreaker pissed off that wyatt escaped
- Nevertheless, their priority still remains the smooth procession of the highvale ball - where they will take their biggest profits
...
- Gang continues and eventually comes across gang of [[Creatures/Kobold]]s 
...
- roll another perception check
	- if perceived, 3 [[Creatures/Kobold]], 1 [[winged kobold]] standing on boar hear them rambling on and cackling 
...
- Someone explains what happened - that's [[Mirabel Emberfall]], her husband [[Orson Emberfall]] is a valued warrior in the town of [[Rorkard]]
- Two weeks ago he went missing, was last seen entering [[Gloomstone Cavern]] along with two other men
- [[Kiara]] says that the real reason she wanted [[Ysgarlad]]'s help was to find [[Orson Emberfall]]
- If whatever in the cavern was strong enough to get [[Orson Emberfall]], her and her friend wouldn't be able to take it on alone
- she points towards her friend who is sitting at one of the tables in the tavern
- reaffirms that they will help her find [[Orson Emberfall]] the next day, and that they will meet outside the [[Cruster Guild (Location)]] at sunrise
...
- The gang meets [[Kiara]] outside of the Cruster Guild along with [[Lunette Emberfall]]
...
- [[Kiara]] and [[Lunette Emberfall]] lock them in the room, where they have to fight [[Gorbold the Gorgeful (statblock)]], [[Korgar the Spiked Menace (statblock)]] and [[Varthis the Cursed (statblock)]]
- Varthis resurrects the skeleton of [[Orson Emberfall]]
...
- The moment she sees [[Ysgarlad]] she drops the tray, it is [[Lunette Emberfall]]
...
- [[Orson Emberfall]] must have knew something was up, so he went to investigate
...
### Opener
- gang still in [[Morgrith's Lair]] exhausted
- allow for a short rest
- can take morgrith's fingernails if they wish - only thing lootable
- throne has a side with 5 holes on it
- if they stick one of morgrith's hands in it the throne opens
- a bunch of heads roll out, also a big pile of coins - 100 + D100 coins each
- after they loot the coins, they see the magic circle starting to glow white
[[Chapter 8#Kalskog]]
### Kalskog
- liri transforms into a bird so that kiara cant leave their vision
- Kiara summons them standing on top of the bell tower
- fight with [[Kiara (statblock)]]
- when kiara uses counterspell for the second time liri drops a rock on her
- Kiara tries to escape through the path leading to the forest to the north east
- Kiara killed and eaten by Amara's wolves who jump in from the forest
- met by Amara Crystus and a guy from the cruster guild in a horse and cart
- Crystus asks where morgrith is
- thanks the gang for their help, says Rorkard is forever indebted to them
- offers them a ride back to rorkard, tells them if they aren't in a hurry, that they should check out some of the famous Skogmead at the inn
[[Chapter 8#Skogbrew Tavern]]
### Skogbrew Tavern
- Before they walk into the inn they see a giant horse tied up outside, one with short tusks coming out of its muzzle
- The gang walks in, see a big crowd gathered around a table at the corner
- if they walk over with skogmead, they find gronk, who takes brogan's and says thank you before going back to laughing
- when he laughs see liri duck behind amara, who also looks pretty startled
- sits down to talk with them, asks them what they are doing in skogbrew tavern of all places
- tells them hes there looking for the lost gemstone
- time to celebrate the gang drinks with gronk
- in the meantime when they get drunk he takes the stone from ysgarlad, slams it on the table
- slightly drunk liri hicupping flies over towards the table
- finds it funny that the fragment of the eternal shadow slightly zapping her fingertips with purple sparks
- she touches it fully
- the stone instantly releases a powerful shockwave of purple energy, causing everyone in the tavern but liri to go flying back, liri is left in the center, with a purple aura around her, looking at her hands with sparks coming off of them, her wings are purple, she turns around to look at the gang in excitement before fainting
...
- **MEETING SPOT**
- You can see some tall spires peeking over the trees. Highvale Manor. Dusk has passed, night has fallen, yet you are the only one here. You start to question yourself, why you were so easy to agree yesterday. Its not like you. You feel your tiredness is setting in from a long day of repetitive thought combined with what restless sleep you had last night. You sit down on a log, your vision fading. As you do, a silhouette appears in front of you. With what little energy you have, you look up and see a familiar face. It's Lyle.
- **LYLE**
- "Ah Wyatt," he says. "Sorry to have kept you waiting." Before you can do anything, you feel a strong impact, and a shock rush down your spine as something smashes into the back of your head. You feel your body collapse, your head hitting the grass. You vaguely make out Lyle shouting "Gotcha!", and then, nothing.
- **CLEAR**
- **SACK**
- Deep beneath Highvale Manor, in the winding tunnels of what is known as The Shacklehold, a group of captives feel the cold stone floor repeatedly hitting their bare feet. Their vision, nothing but the sacks they wear over their heads. After what seems like an eternity, they finally come to a halt. Soon, a voice.
- "This one can go in cell 58, that one can go aswell. Put those two in a cell together its a mother daughter pair."
- Discomforted grunts and screams can be heard from the various prisoners being paraded off in all different directions.
- "Put the green one with gribbles. And, ah, him, leave him here. Our Lord wishes to see him."
- As one prisoner, a goblin, is thrown into a nearby cell, the last prisoner is left on his knees alone.
- As quiet settles in, distant footsteps can be heard walking the halls of the Shacklehold. With each step, louder and louder, until. The lone prisoner's sack is ripped off of his head.
- **HALLWAYS**
- The prisoner takes in his surroudings, a cold stone maze, before looking to the towering figure in front of him.
- The man puts his hands on his head and cracks his neck.
SCRUNCH NOSE - american - change mic input - turn on voice
...
*I believe we'll make quite an example of you, Holloway. Perhaps I'll even let you keep your tongue, so you can witness firsthand how utterly meaningless your antics have been. After all, what's more devastating than watching everything you've fought for crumble while you serve the very system you sought to destroy?"*

- Chains drop from his sleeves, and with a grunt, he whips Wyatt across his back. He then throws one of wyatt's pistols on the floor in front of him, and snaps it in two with nothing but his boot.
- The man puts his hands on his head and cracks his neck again.
- He laughs, before nodding to the guards and walking away. The guards throw wyatt into a nearby cell.
- **CELL**
### Plot - Escaping Shacklehold
- Mugwort and wyatt regain their witts in the cell, they see an old man sitting in the corner.
- "that was quite the beating you got, here let me help you"
- gribbles heals his back
- couple days past
- gribbles decides they are worthy
- tells them of an upcoming time when the strongest members of the shacklehold are all out on an escort mission
- "thats when we escape"
- "ive been here for years and years, i know the inns and outs etc."
- "ill also have this" - pulls out and shows them lock pick.
- fast forward to day of escape
- noticably fewer guards
- gribbles unlocks door when guards aren't looking
- just as they step out first guard sees them
- before anything gribbles disarms him and shoots the club to wyatt
- COMBAT
- gribbles suggests going and finding their gear
- tells them "your gear might be in one of two places, the master's quarters or the vault, which should we go to"
- go to chosen place
- gribbles babbling as they walk
- master's quarters has buyers ledger
- chosen place doesn't have anything, but has coin
- second place has their gear, but as gribbles is unlocking the door two guards show up
- COMBAT, PROTECT GRIBBLES - GRIBBLES INITIATIVE FIRST GLUE TRAP BOTH OF THEM
- half way through combat gribbles unlocks door, throws wyatt one of his pistols from inside
- combat continues
- after combat go loot room
- gribbles mends other pistol
- bla bla bla
- run and escape to court yard
- "no time to free the other slaves now, we'll come back"
- COMBAT WITH BRUTE
- gribbles casts dizzy headache,
- bla bla bla
- combat end
- gribbles shot as they escape

- at some point running out they hear a dragon shout coming from deeper floors within Shacklehold

#### Landscapes
- [x] mugwort's stall
- [x] tavern that wyatt is in
- [x] wyatt meetup spot at night
- [x] slave cell
- [x] slave grounds
#### Splashes
- [x] mugwort
...
- [x] old curly
- [x] masked man
- [x] mystery meetup for wyatt man
- [x] figures who show up to mugwort's stall
- [x] guard 1
- [x] guards 2 and 3
- [x] brute
- [ ] hextech pistols on desk
- [ ] gribbles fading
#### Battlemaps
- [x] underground hallway fight
- [x] hallway 2
- [x] courtyard
...
- [x] Wyatt story
- [x] Mugwort story
- [x] Story as to why the brutes are leaving
- [x] Willbreaker voice
- [x] Trinkets for artificer to use
- [x] Ledger/story item
- [x] Gribbles statblock
- [x] Guard 1 statblock
- [x] Guard 2 statblock
- [x] Guard 3 statblock
- [x] Brute statblock
...
#hidden 
### Preface
- gang took a short rest in [[Morgrith's Lair]]
...
### Opener
- gronk returns to gilbreives saying that he needs to train gilbreives against another attack, kind of shameful that one man was able to infiltrate and steal one of their prized posessions so easily. must restore peace to gilbreives
- sets off on gronkus maximus back into the verdant forest, saying he wishes them luck and fortune on their adventure

### Plot - Halibon's Shack
- as they walk along the ridge through the rain, the gang sees a small house come into view
- outside they see a hooded figure sitting on the grass, smoke emitting from his hand
- they see him look towards them and raise his hand, smoke growing larger
- the smoke starts swirling and eventually forms into a large hand, which then waves at the gang
- as they walk closer they see halibon
- they hear a voice - you all look freezing hahaha, it seems florion is sorrowful today as always
- he stands up and walks towards the door
- My name is Halibon, please, allow me to offer my hospitality for those who wish to rest and find comfort in a warm meal
- opens the door and points inside
- see a small interior, with a fireplace in the corner of the room with a pot dangling above it, an arm chair next to it facing out into the room, two sofas facing the fireplace, and a small table behind towards another smaller room which is the kitchen
- as they walk in, halibon walks over to the fireplace and flicks a spark off of his pipe
- the spark lands in the fireplace and slowly ignites into a cozy fire
- please, make yourselves at home, feel free to hang your cloaks to dry by the fire, and have a seat
- behind the sofas is a large bookshelf, filled with titles from all different manners
- halibon walks over and sits in the chair by the fireplace, before starting chat with the gang
- after a bit he realises the stew is ready, goes into another room
- brings out wooden bowls, and an eggcup, and some spoons, sets them down in the arm chair
- he takes the lid off of the pot, and the room is filled with an aroma that makes them instantly feel warm and cozy
- he pulls out a wooden label and starts dishing out stew to each person
- warm hearty stew with potatoes, some chunks of meat, other vegetables, brings out a bread bun for everyone
- after eating the stew, halibon looks pensively out of the window
- talking to himself but out loud
- 25 years, 25 years florion has not stopped crying, he has never been seen like this since the coalescence
- halibon tells the story of the coalescence
- In a Spiritual plane, far outside our realm of existance, there was once a war. The war between the Everlasting Light, seeking out life, emotion and existance, and the Eternal Shadow, seeking out silence, darkness, and emptiness. The war was fought between these two spiritual entities for an incomprehensible amount of time, before the Everlasting Light finally managed to overcome and seal the Eternal Shadow. However, this caused the Everlasting Light to split into 6 fragments, 6 Brothers. each with a so called God Heart that held a portion of the power of the Everlasting Light. Eventually as these brothers grew, they became bored of the spiritual plane, and decided to create a new realm of existance. They came together with the power of each of their God Hearts, fabricating reality as we see it around us. Cordisalia. It is said they now watch from the cosmos over each of their vast lands, and that they each left a powerful protector in their stead.
- Halibon walks over to the bookshelf and pulls out an old book, before dusting it off.
- Florion Overseer of the Verdant Continent, his protector Aladaroth the Ancient Sentinal
- Serrok Overseer of the Arid Continent, and his protector Miragor, the Scourge of the Sands
- Illusia, Overseer of The Mirage, and his protector Shambari, the Dream Weaver
- Pyraust, Overseer of the Burning Expanse, and his protector Infernox, the Blaze Sovereign
...
### Chapter 1 - The Lumber Festival.md
...
### Chapter 10.1 - Murlin the ''Magician''.md
...
As the gang adventured through the [[Verdant Continent]], unbeknownst to them, one small yet adventurous man was tracking them down. He'd arrived in [[Wyrmsgard]], where he decided to wait for his brother [[Brogan Stone-Flask|Brogan]] to show up. His name, [[Murlin]].
![[Murlin.png]]
****
...
### Chapter 10.2 - Enter! Wyrmsgard!.md
...
### Chapter 2 - Into the Verdant Forest.md
...
### Chapter 3 - The Dangling Tradesman.md
...
### Chapter 5 - Kiara's Deception.md
...
### Chapter 7 - Morgrith's Final Banquet.md
...
###### Overview
- [[Crausse]] is a creature merchant from [[Wyrmsgard]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- Gave [[Murlin]] the reward for the [[Bugbear]] loot
- Sent a chill down [[Wyatt Holloway|Wyatt's]] spine, unbeknownst to the rest of the gang
- Offered the gang more work, should they want it
- According to [[Wyatt Holloway|Wyatt's]] informant, he is a well known figure in [[Wyrmsgard]], on good terms with pretty much most people that he interacts with
- He's been in the city for the past decade and a half
- Apparently he leaves [[Wyrmsgard]] and comes back quite regularly
...
> *Welcome to Rorkard my friends.*
###### Overview
- [[Crystus]] is the leader of the [[Cruster Guild]] in [[Rorkard]]
- He possesses extensive knowledge about stones and ancient artifacts
- Oversees mining operations in the [[Gloomstone Cavern]]
- A relaxed and kind man
###### Appearances
...
- An ex-adventurer, she has become highly adept at gardening in her later years, cultivating many rare and sought after plants
- She is friends with [[Hoagle]]
- She is famous among few for her delicious fruit cake
###### Appearances
###### [[Chapter 4 - Rorkard at Last]]
- Hosted the gang after they helped [[Hoagle]] in the [[Verdant Forest]]
- Eased some of [[Liri|Liri's]] initial nerves
...
- She gave [[Ysgarlad]] one of her notorious fruit cakes to deliver to [[Sarmon]]
...
![[Evie 1.png]]
> *Aye, welcome to [[Lythorax's Roost]]!*
###### Overview
- [[Evie]] is a woman from [[Wyrmsgard]] and a bartender at [[Lythorax's Roost]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- Greeted [[Murlin]] and the gang when they entered and stayed at [[Lythorax's Roost]]
- Called [[Lysander]] "prince highvale" and shood him off saying that she was "too busy for his recent stupid obsession with [[The Veilstalker]]"
...
- He is notoriously known for having 27 wives
- A frequent patron at the [[Rocky Refuge]]
###### Appearances
###### [[Chapter 5 - Kiara's Deception]]
- He met the gang at the [[Rocky Refuge]], rambling about his wives
###### [[Chapter 6 - Meat for Mother]]
- Rambled on to the gang in a drunken state whilst they were trying to catch [[Kiara]]

### Gorbold the Gorgeful.md
...
> *Bwahahaha!! ~tosses barrel~  ... aw fuck.*
###### Overview
...
###### Appearances
###### [[Chapter 5 - Kiara's Deception]]
- He fought with the gang and was killed by [[Ysgarlad]] during their extremely close bout in [[Gloomstone Cavern]]
...
*Human Male 65 ???*
![[Gribbles.png]]
> *William! I've been here between four and six years I think! Take this- dizzy headache!*
###### Overview
- Gribbles was a man who had been trapped in [[The Shacklehold]] for over 5 years
- Gained the title "the Gob" due to his notoriety for talking on and on and on to great lengths about any subject - he was never sold due to this fact
###### [[Chapter 9.2 - Gribbles' Gambit]]
- Healed [[Wyatt Holloway|Wyatt]] after he was lashed by [[The Willbreaker]] upon his capture
- Decided that [[Mugwort Snaggletooth|Mugwort]] and [[Wyatt Holloway|Wyatt]] were worthy, and so decided to help them escape [[The Shacklehold]]
- Died to an arrow through the chest just as they were escaping over the bridge at [[Highvale Manor]]
- Trusted [[Wyatt Holloway|Wyatt]] and [[Mugwort Snaggletooth|Mugwort]] to come back and free the slaves with his dying words
...
###### Overview
- [[Gronk Growheart]] is the overtly charismatic son of [[Grink Growheart]] and a man from [[Gilbreives]]
- He holds the record for most wins in the [[Lumber Festival]] wood chopping competition
- Popular with ladies, he has trouble keeping his manly urges under control 
- His wife is [[Rowena Growheart]], who is often annoyed at him for his repeated narcissism and misogyny
###### Appearances
###### [[Chapter 1 - The Lumber Festival]]
- Won in an arm wrestle with [[Ysgarlad]], only to lose his right arm trying to prevent the [[Hooded Man]] from escaping with the [[Fragment of the Eternal Shadow]]
...
###### Overview
- [[Hoagle]] is a travelling trader with a magic bag that transforms into a trading stall
###### Appearances
...
###### Overview
- [[Kiara]] was a mage thief from [[Rorkard]]
- Her father ran the [[Abandoned Thieves Guild]] back in its prime days, before it was shut down
- Deceitful, she does not have trouble putting on a pretty face to get what she wants
###### Appearances
###### [[Chapter 4 - Rorkard at Last]]
...
###### [[Chapter 8 - Surprise Attack!]]
- Summoned the gang into [[Kalskog]], thinking she was summoning [[Morgrith the Mother|Morgrith]]
- Fought with the gang, along with her [[Kiara's Rats|Rats]]
- After a near escape, she was captured and interrogated by [[Ysgarlad]]
- Mauled to death by [[Amara's Red Wolves]]

### Korgar the Spiked Menace.md
...
- Has the ability to turn into various creatures and critters
- Originally very nervous, she now has a very excited demeanour, and enjoys adventuring
###### Appearances
###### [[Chapter 3 - The Dangling Tradesman]]
...
###### [[Chapter 4 - Rorkard at Last]]
- Turned into a boar to help the gang during their fight in [[Elinor|Elinor's]] Cabin
...
###### [[Chapter 5 - Kiara's Deception]]
- Got some much needed new clothes at the [[Ironhand Forge]]
- Had her spirit read by [[Shanya]], resulting in [[Shanya]] freaking out
###### [[Chapter 6 - Meat for Mother]]
- Transformed into a mouse to try and help the gang escape [[Gloomstone Cavern]] after their fight with the [[Cannibals of Gloomstone Cavern]]
- Was thrown by [[Ysgarlad]] to distract [[Morgrith's Servant|Mother's Servant]] as the gang were rescuing [[Amara]]
- Transformed into a bird to help the gang get back to [[Rorkard]] after escaping [[Gloomstone Cavern]]
- Fell unconscious after unleashing a mysterious purple blast in an effort to protect the gang from a group of [[Bugbear|Bugbears]]
###### [[Chapter 7 - Morgrith's Final Banquet]]
- Doesn't remember what happened with the [[Bugbear|Bugbears]] after asked by [[Ysgarlad]]
- Acts as a surveillance mouse when [[Brogan Stone-Flask|Brogan]] and [[Ysgarlad]] went to the [[Emberfall Household]]
- Does not remember [[Amara]] similar to the [[Bugbear|Bugbears]]
###### [[Chapter 8 - Surprise Attack!]]
...
> *I didn't know what she was going to do! Please, I swear...*
###### Overview
...
###### [[Chapter 7 - Morgrith's Final Banquet]]
- Was interrogated by [[Ysgarlad]] and [[Brogan Stone-Flask|Brogan]] in the [[Emberfall Household]] after being dusted with [[Aetherquartz Powder]]
- Revealed that she did in fact think that they were going to rescue [[Orson Emberfall|Orson]], but [[Kiara]] decided to spare her from the cannibals in the last moment
- Informs the gang of her once sister-like relationship with [[Kiara]], and bout her father's [[Abandoned Thieves Guild|hideout]]
...
###### Overview
- [[Lyle]] is a mysteriously charming man who appears to be working for [[The Shacklehold]]
###### Appearances
###### [[Chapter 9.1 - Retribution, Cuisine]]
- [[Lyle]] approached [[Wyatt Holloway]] at a traveller's tavern in [[Florion's Ridge]]
...
- When they met up to do the raid, he instead captured [[Wyatt Holloway|Wyatt]] and imprisoned him in [[The Shacklehold]]
...
*Human Male ??? ???*
![[Prince Highvale.png]]
> *I'd rather be judged by my own actions than some random letters given to me at birth - anyway, more importantly, I think I've got it figured out!*
###### Overview
- Not much is known yet about [[Lysander]] apart from that he is likely from the [[Highvale Family]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- Interrupted the gang and [[Evie]] in [[Lythorax's Roost]]
- Was shood away by [[Evie]] who called him "prince highvale" and said she was "too busy for his stupid recent obsession with [[The Veilstalker]]"

### Magistrix Orinthe.md
...
###### [[Chapter 7 - Morgrith's Final Banquet]]
- Was informed by [[Ysgarlad]] and [[Brogan Stone-Flask|Brogan]] of [[Orson Emberfall|Orson's]] death after their escape from [[Gloomstone Cavern]]

### Morgrith the Mother.md
...
aliases:
  ...
  - Morgrith
---
*Giant Female ??? [[Gloomstone Cavern]]*
![[morgrith.png]]
...
aliases:
  - Mother's Servant
---
*Human Male ??? [[Gloomstone Cavern]]*
![[Servant of Morgrith.webp]]
> *Meat for mother... meat for mother...*
###### Overview
- [[Morgrith's Servant]] was one of the [[Cannibals of Gloomstone Cavern]]
- He was tasked with making sure mother was constantly fed more and more flesh
###### Appearances
###### [[Chapter 6 - Meat for Mother]]
...
![[Murlin.png]]
> *Gausse, these are my followers!*
###### Overview
- [[Murlin]] is a "wizard" from the Stone-Flask family in the [[Burning Expanse]]
- His "magic" manifests as contraptions, gadgets, and tricks rather than traditional spellcasting
- Renamed himself after [[Merlin the Mystic]] from "The Chronicles of Merlin the Mystic," his favourite book
- Obsessed with finding resurrection magic to bring back his childhood friend [[Morgan A]], whom only he could see
...
---
###### Overview
- A well known glutton from [[Wyrmsgard]], and apparent inventor of the [[Triple Gwongberry Stuffed Muffin]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- His name was mentioned when [[Torbert]] told the gang about [[Wee Gwyndaff]] and the tale of the [[Double Gwongberry Stuffed Muffin]]
...
- He is secretly a [[Post Mortem]] informant
###### Appearances
###### [[Chapter 5 - Kiara's Deception]]
- Sold [[Brogan Stone-Flask|Brogan]] some nails
###### [[Chapter 7 - Morgrith's Final Banquet]]
- Was revealed to be the [[Post Mortem]] secret informant in the [[Rorkard Sewers]]
- Told the gang the history of the [[Abandoned Thieves Guild]] and the [[Cruster Guild]]
- Told them how to find the [[Abandoned Thieves Guild]]
...
###### [[Chapter 6 - Meat for Mother]]
- Got into an argument with [[Ysgarlad]] about the money he was owed, resulting in [[Kiara]] escaping from the [[Rocky Refuge]]
- Was informed by the gang about [[Kiara|Kiara's]] antics, resulting in him loosening the payment deadline
- Told the gang where to find [[Mirabel Emberfall]]
###### [[Chapter 8 - Surprise Attack!]]
- Was finally paid by the gang, only for the [[Rocky Refuge]] to be wrecked again by [[Liri|Liri's]] purple explosion
...
---
###### Overview
- Not much is known about [[The Veilstalker]] other than the name keeps getting mentioned around [[Wyrmsgard]]
...
aliases:
---
*Human Male 65 [[Wyrmsgard]]*
![[Torbert 1.png]]
> *Aye, welcome to [[Torbert's General]]! Would you like to try some of our new baked goods?*
###### Overview
- [[Torbert]] is a man from [[Wyrmsgard]], the owner of [[Torbert's General]], and the father of [[Wee Gwyndaff]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
...
> *Ah shit me bombo skelly gwan an fookin dyied*
###### Overview
...
aliases:
---
*Human Male 11 [[Wyrmsgard]]*
![[Wee Gwyndaff.png]]
> *Welcome to [[Torbert's General|Torbert's Baked Goods]]! Would you like to buy some of our general items?*
###### Overview
- [[Wee Gwyndaff]] is a boy from [[Wyrmsgard]], and the son of [[Torbert]]
- He is an aspiring baker, inventor of the [[Double Gwongberry Stuffed Muffin]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- Greeted the gang when they entered [[Torbert's General]]
- Could be heard crying when [[Torbert]] told the tale of the [[Double Gwongberry Stuffed Muffin]]
...
> *Woo baby, woo.*
###### Overview
- Her true origins unknown, [[Ylvëstrïa|Ylvëstrïa's]] first memories are from being raised in the slums of [[City of Virridius|Virridius]] around the age of five
- She discovered her natural acuity for magic when breaking into a mage's shop at age twelve
- Instead of reprimanding her, the mage, [[Magistrix Orinthe]] taught her how to harness the latent magical energy surrounding her
- After [[Magistrix Orinthe]] died of natural causes a few years later, [[Ylvëstrïa]] found herself homeless again
 - At this point, age fourteen, she caught the attention of the organisation [[Post Mortem]], who recognized something unusual in her magical signature and recruited her for her talents in infiltration
 - [[Post Mortem]] utilized her skills in breaking into secured locations to plant evidence or retrieve documents, while providing her with arcane texts in return. This relationship continued up until her recent departure from the [[City of Virridius]]
- Since leaving the [[City of Virridius|Virridius]], she has been adventuring independently, still relying on [[Post Mortem]] outposts as a reliable information source
- She maintains a personal code of justice despite her criminal activities, often targeting bullies and those who abuse power
###### Gallery
|                                                |                        |
| ---------------------------------------------- | ---------------------- |
...
![[red wolves.png]]
###### Overview
- Two large red wolves summonable by and loyal to [[Amara]]
###### Appearances
[[Chapter 8 - Surprise Attack!]]
- Mauled [[Kiara]] to death after her capture and interrogation by [[Ysgarlad]]
...
![[bugbear crew 1.webp]]
###### Overview
- A distant but much more savage relative to the goblin
- What proficiency they have in ferocity, they lack in any semblance of reasoning or cognition
###### Appearances
###### [[Chapter 6 - Meat for Mother]]
- A group was encountered after the gang rescued [[Amara]] from [[Gloomstone Cavern]]
- Showing aggression towards the gang who were already beaten up, they caused [[Liri]] to awaken some form of innate power that she used to scare them away
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- A group of three of the red variety stumbled upon and were subsequently killed by the gang in the [[Cragneedle Woods]] while helping [[Murlin]] with his job and finding [[Mugwort Snaggletooth|Mugwort]] and [[Wyatt Holloway|Wyatt]]
- They were drawn to the smell of [[Mugwort Snaggletooth|Mugwort's]] cooking
###### Gallery
|                                                                |                                                                         |
| -------------------------------------------------------------- | ----------------------------------------------------------------------- |
| *Ambush outside [[Gloomstone Cavern]]*![[bugbear crew 1.webp]] | *Intrigued by slop in the [[Cragneedle Woods]]*![[Bugbears Hungry.png]] |
...
![[kiaras rats.webp]]
###### Overview
- Three giant rats summonable by [[Kiara]]
- Have a keen sense of smell, along with a venomous bite
###### Appearances
###### [[Chapter 8 - Surprise Attack!]]
- Summoned by [[Kiara]] into [[Kalskog]] to help in her fight against the gang
...
---
###### Overview
- Not much is known about the [[Ashmount Family]] apart from that they are a family relatively new to nobility and [[Wyrmsgard|Wyrsmgard's]] aristocracy

### Cannibals of Gloomstone Cavern.md
...
###### [[Chapter 6 - Meat for Mother]]
- The gang rescued [[Amara]] from her torture, killing [[Morgrith's Servant]]
###### [[Chapter 7 - Morgrith's Final Banquet]]
- The gang fought and killed [[Morgrith the Mother]] after discovering [[Kiara|Kiara's]] plan to summon her in [[Kalskog]] and [[Rorkard]]
###### Gallery
|                                                                    |                                                                |
| ------------------------------------------------------------------ | -------------------------------------------------------------- |
| *[[Korgar the Spiked Menace]]*![[Pasted image 20240611203608.png]] | *[[Gorbold the Gorgeful]]*![[Pasted image 20240611204602.png]] |
| *[[Varthis the Cursed]]*![[Pasted image 20240611203955.png]]       | *[[Morgrith the Mother]]*![[morgrith.png]]                     |
| *[[Morgrith's Servant]]*![[Servant of Morgrith.webp]]              |                                                                |
...
###### Appearances
###### [[Chapter 4 - Rorkard at Last]]
- The gang spoke to [[Crystus]] in the [[Cruster Guild]] to learn more about the [[Fragment of the Eternal Shadow]]
###### Gallery
|                                          |                                                   |
| ---------------------------------------- | ------------------------------------------------- |
...
---
###### Overview
- The [[Highvale Family]] is a very important family sitting atop the aristocracy of [[Wyrmsgard]], and the owners of [[Highvale Manor]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- The gang briefly met [[Lysander]] after arriving in [[Wyrmsgard]], however did not get to speak to him
- The [[Highvale Family]] name was written all over the buyer's ledger that [[Mugwort Snaggletooth|Mugwort]] and [[Wyatt Holloway|Wyatt]] took from [[The Shacklehold]], as well as a note about a supposed upcoming ball
###### Gallery
|                                                   |                                        |
| ------------------------------------------------- | -------------------------------------- |
| *[[Highvale Manor]]*![[Shacklehold Outdoors.png]] | *[[Lysander]]*![[Prince Highvale.png]] |
...
---
###### Overview
- The [[Lyosønn Family]] is a noble family from the [[City of Isdal]]
- [[Ysgarlad]] is of the [[Lyosønn Family]]
...
---
###### Overview
- Not much is known about the [[Scalebinder Family]] apart from that they are a family moderately high up in [[Wyrmsgard|Wyrmsgard's]] aristocracy
...
###### Appearances
###### [[Chapter 5 - Kiara's Deception]]
- It seemed to be the source of the [[Hooded Man|Hooded Man's]] power during his fight with the gang in the [[Rocky Refuge]]
...
###### [[Chapter 8 - Surprise Attack!]]
- [[Ylvëstrïa]] cast identify on it, causing her to see a vision of some sort of magical network

### Double Gwongberry Stuffed Muffin.md
...
---
###### Overview
- The [[Double Gwongberry Stuffed Muffin]], the signature dish of [[Wee Gwyndaff]]
- The recipe was apparently stolen by [[Mustros]], who then created the [[Triple Gwongberry Stuffed Muffin]]
...
### Fragment of the Eternal Shadow.md
...
![[Gwongberries.png]]
###### Overview
- A fruit native to the [[Cragneedle Woods]], and the main ingredient in the [[Double Gwongberry Stuffed Muffin|Double]] and [[Triple Gwongberry Stuffed Muffin]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- A punnet was bought by [[Mugwort Snaggletooth|Mugwort]] in [[Torbert's General]]

### Korgar's Greatclub.md
...
- when applied to a weapon
	- once per long rest can be used to increase weapon speed with wind, effectively reducing the target's AC by 4 for that hit roll, and adding 2 damage to the subsequent damage roll

### Lesser Pink Lodestone.md

---
draft: "true"
aliases:
---
![[lesser pink lodestone.png]]
...
![[Lilacmary.png]]
###### Overview
- A herb native to the [[Cragneedle Woods]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- A pot was bought by [[Mugwort Snaggletooth|Mugwort]] from [[Torbert's General]]
...
|                                                           |                                                             |
| --------------------------------------------------------- | ----------------------------------------------------------- |
| *Lesser Green Lodestone*![[lesser green lodestone 1.png]] | *Lesser Pink Lodestone*<br>![[lesser pink lodestone 1.png]] |
...
### Triple Gwongberry Stuffed Muffin.md
...
---
###### Overview
- A knock off / improvement of the [[Double Gwongberry Stuffed Muffin]], stolen from [[Wee Gwyndaff]] and created by [[Mustros]]

## Directory: Lore

### Aladaroth, the Ancient Sentinel.md
...
### Infernox, the Blaze Sovereign.md
...
### Miragor, Scourge of the Sands.md
...
### Regnir, Soldier of the Storm.md
...
aliases:
---
- [ ] turn based arena shifting
- [ ] teamsave - character in danger doesn't realise they're in danger, someone else has to help
- [ ] 
...
---
## Playlists
[Skyrim Collection](https://www.youtube.com/playlist?list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO)
[Mass Effect Collection](https://www.youtube.com/playlist?list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc)

## Male
- [ ] [Diablo IV Barbarians](https://youtu.be/x-ljpxCKfJk?si=4s0PE6WnH7WK53Y2)
- [x] [Diablo IV Bloodied Wolf](https://youtu.be/csqDWKZYOOA?si=KFLgCQu-L-ziPmrf)
- [x] [Diablo IV Necromancers](https://youtu.be/68OM_8agGr4?si=UANy6IFkgXj-4t6V)
- [ ] [Diablo IV Sorcerers](https://youtu.be/0czRZVGfwmE?si=aSt5VxDaPZKK9fXC)
- [ ] [Diablo IV Rogues](https://youtu.be/fp_iy1FX4Vo?si=aSyeYmnzYr7MRWOE)
- [ ] [Diablo IV Druids](https://youtu.be/z-6xDgP-Im8?si=7Jk8mLznd1DIFQDw)
- [ ] [Skyrim Arnegir](https://www.youtube.com/watch?v=bSAKTzAEySg&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=4)
- [ ] [Skyrim Paarthurnax](https://www.youtube.com/watch?v=VdbOAWjOifs&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=6)
- [ ] [Skyrim Erandur](https://www.youtube.com/watch?v=gnUm4TeLBJM&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=8)
- [ ] [Skyrim Amaund Motierre](https://www.youtube.com/watch?v=8-Jo04y9TsM&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=69)
- [ ] [Skyrim Sheogorath](https://www.youtube.com/watch?v=KffrWrShGho&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=41)
- [ ] [Mass Effect Illusive Man](https://www.youtube.com/watch?v=Pm9fBUTVAFY&list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc&index=6)
- [ ] [Mass Effect Mordin](https://youtu.be/2V6yrOTrZQQ?si=wIy8E0MJF6NB0EE1)
- [x] [Mass Effect Grunt](https://www.youtube.com/watch?v=90BVPM8PbEE&list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc&index=12)
- [ ] [Mass Effect Zaeed](https://www.youtube.com/watch?v=Wf0DHQX9L1Y&list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc&index=14)
- [ ] [The Witcher 3 Geralt](https://www.youtube.com/watch?v=rG3PxYIm9W8&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH)
- [ ] [The Witcher 3 Letho](https://www.youtube.com/watch?v=VHdsXXaurbY&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH&index=10)
...
- [ ] [Diablo IV Rogues](https://youtu.be/fp_iy1FX4Vo?si=aSyeYmnzYr7MRWOE)
- [ ] [Diablo IV Druids](https://youtu.be/z-6xDgP-Im8?si=7Jk8mLznd1DIFQDw)
- [ ] [Maven Black Briar](https://www.youtube.com/watch?v=8t8Z8O_VSZY&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=18)
- [ ] [Skyrim Karliah](https://www.youtube.com/watch?v=a2q7It-w4-c&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=17)
- [ ] [Skyrim Serana](https://www.youtube.com/watch?v=U6qrkJ4BjRw&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=42)
- [ ] [Skyrim Vex](https://www.youtube.com/watch?v=T5jH9wjKG34&list=PLVsNqYJ394l7rJuc1-UDdpPCMX3G0k8cO&index=16)
- [ ] [Mass Effect Jack](https://www.youtube.com/watch?v=KWEMVOtbEek&list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc&index=13)
- [ ] [Mass Effect Shepard Female](https://www.youtube.com/watch?v=uSEv6MW9jWo&list=PL4sG3ZyWkBjDif1hYYM9so0q-B3JXMRnc&index=16)
- [ ] [The Witcher 3 Ciri](https://www.youtube.com/watch?v=uawyhgtaEvY&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH&index=4)
- [x] [The Witcher 3 Yennefer](https://www.youtube.com/watch?v=bNlLht86AkI&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH&index=8)
- [ ] [The Witcher 3 Triss Merigold](https://www.youtube.com/watch?v=E9GjxByWPZE&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH&index=9)
- [ ] [The Witcher 3 Keria Metz](https://www.youtube.com/watch?v=RGaI3KuczeU&list=PL4sG3ZyWkBjA_NC1gMC6T9ynTWoB3rQfH&index=13)
...
aliases:
---
![[Pasted image 20250602120918.png]]
- [x] Murlin Introduction / Brogan / Amara Sendoff
- [x] Join up with Wyatt and Mugwort
- [x] Torbert's Baked Goods
- [x] The Ledger
- [x] The Highvale Son
- [x] The Spirit Rumour
- [x] Crausse Creature Catching / Assassination Attempt
- [x] Missing Dragon
- [x] Highvale Ball
- [x] The Heist
- [x] Missing Dragon
...
- [x] The Circlet
- [x] The Dismal King
- [x] Dragon Rider Daughter
- [x] Drakenspire Conservatory
- [x] The Shacklehold
- [x] Scale Test
- [x] Eye of Mortem
- [x] Haldor
...
### Act 1 - Lyle?
- Murlin Introduction / Brogan / Amara Sendoff
- Bugbear Hunting
- Join up With Wyatt and Mugwort
- The Ledger
- The Spirit Rumour
- The Highvale Son
- Missing Dragon
...
##### Cragneedle Woods
- the next morning when they are on the way to murlin's quest, they walk past where the little boy was begging for money, they see a single brown glove on the floor
- 

### Act 2 - Kaelus + Nythria?
- Crausse Creature Catching / Assassination Attempt
- Torbert's Baked Goods
- Eye of Mortem
- The Dismal King
- Dragon Rider Daughter
- Drakenspire Conservatory
- Scale Test
- Haldor
### Act 3
...
#### Extra notes
- visage figures out ysgarlad is a lyosonn, pretends to be his relative and ends up trying to kill him or smoething

- woos dream - sees shadowy figure of dragon, wakes up, sees liri asleep with faint sparks of purple

### Haldor
after his son turned into visage, met with enormous grief, turned to spiritualism, monk mode etc, now spends most of his days in the mountains meditating, has split personality - super whimsical and goofy, ridden with grief
...
- [x] midjourney for images
- [x] w-okada for voice conversion
- [ ] arcane gunslinger syndicate for wyatt
- [ ] chase up on mugwort backstory

## Directory: Points of Interest

### Abandoned Thieves Guild.md
...
aliases:
---
![[Cragneedle Woods.png]]
###### Overview
- The [[Cragneedle Woods]] is a mountainous coniferous forest lying to the east of [[Wyrmsgard]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- The gang found [[Wyatt Holloway|Wyatt]] and [[Mugwort Snaggletooth|Mugwort]] in the [[Cragneedle Woods]] whilst hunting red [[Bugbear|Bugbears]]
...
|                                                                                                                                                                                                                      |                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| *Main Entrance*![[Pasted image 20240610203027.png]]                                                                                                                                                                  | *Mining Tunnels*![[cave 2.png]] |
| *[[Morgrith's Lair]]*![[DALL·E 2024-04-12 19.23.35 - A large, expansive lair inside a cave, depicted in a gritty medieval fantasy painting style. The room is dark and vast, illuminated only by numerous l 1.webp]] |                                 |


### Great Tree of Gilbreives.md
...
aliases:
---
![[Lythorax's Roost 1.png]]
###### Overview
- [[Lythorax's Roost]] is a popular tavern / inn in [[Wyrmsgard]], featuring both indoor and outdoor areas, large enough to house dragons
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- The gang stayed at [[Lythorax's Roost]], meeting [[Evie]], a bartender, and briefly [[Lysander]]
- [[Mugwort Snaggletooth|Mugwort]] set up his slop stall outside
...
aliases:
---
![[DALL·E 2024-04-12 19.23.35 - A large, expansive lair inside a cave, depicted in a gritty medieval fantasy painting style. The room is dark and vast, illuminated only by numerous l 2.webp]]

### Norbert's General.md
...
|                                                        |                                                          |
| ------------------------------------------------------ | -------------------------------------------------------- |
| *The Rocky Refuge*![[Pasted image 20240610201559.png]] | *[[Hooded Man\|Hooded Man's]] Room*![[inn bedroom.webp]] |
...
### Torbert's General.md

---
draft: 
aliases:
---
![[Torbert's General.png]]
###### Overview
- [[Torbert's General]] is a general goods store and newly acclaimed bakery in [[Wyrmsgard]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- The gang shopped here, meeting [[Torbert]] and [[Wee Gwyndaff]]
- [[Ysgarlad]] bought some plate armour
- [[Mugwort Snaggletooth|Mugwort]] bought some [[Lilacmary]] and some [[Gwongberry|Gwongberries]]
- [[Wyatt Holloway|Wyatt]] bought some throwing knives and some health potions
- [[Murlin]] took the book [[Books/Tale of the Stonemancer]] as part of [[Torbert|Torbert's]] "Bookwyrms" scheme
...
![[Wyrm's Shadow.png]]
###### Overview
- A shady back alley market in [[Wyrmsgard]]
###### Appearances
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- The gang met [[Crausse]] outside his store in [[Wyrm's Shadow]] to get their reward for the [[Bugbear]] loot
- [[Ylvëstrïa|Woo]] came back later to investigate the area
- [[Wyatt Holloway|Wyatt]] met with a criminal associate
...
![[Wyvern's Port.png]]
###### Overview
- A small shipping port in the north of [[Wyrmsgard]], requiring the use of the northern dragon lift to get there
###### Appearances
###### [[Chapter 10.1 - Murlin the ''Magician'']]
- [[Murlin]] landed in [[Wyvern's Port]] after embarking from the [[Burning Expanse]] across the [[Crimson Sea]]
###### [[Chapter 10.2 - Enter! Wyrmsgard!]]
- [[Brogan Stone-Flask|Brogan]] departed from [[Wyvern's Port]] to go look after his mother in the [[Burning Expanse]]
...
### Gorbold the Gorgeful (statblock).md
...
## Gribbles
**HP:** 12
**Saving Throws:** STR +0, DEX +2, CON +1, INT +3, WIS +2, CHA +1

**Spells:**
- **Glue Trap:** Enemies in 10ft radius must make a DEX save (DC 13). On fail, they are trapped for 2 turns and attacks against them have advantage.
- **Healing Word:** Bonus action, restores 1d4+2 HP to target within 60ft.
- **Mend:** Repairs a single break or tear in an object.
- **Disarm:** Target's weapon flies 15ft in a direction Gribbles chooses. Can be used once per short rest.
- **Dizzy Headache:** Target must make a CON save (DC 13). On fail, takes 1d6 psychic damage and has disadvantage on their next attack roll.

**Items**:
- Crude lockpick, can unlock any door in the shacklehold but takes a minute to use.

### Hooded Man (statblock).md
...
### Korgar the Spiked Menace (statblock).md
...
### Morgrith the Mother (statblock).md
...
### Morgrith's Servant (statblock).md
...
### Skeleton (statblock).md

---
draft: "true"
aliases:
---
![[Pasted image 20240327233742.png]]

### Slave Camp Guard (statblock).md
...
## Basic Guard
**HP:** 10
**Action:** Wooden Club: +2 to hit, 3 (1d4 + 1) bludgeoning damage

## Veteran Guard
**HP:** 12
**Action:** Wooden Club: +3 to hit, 4 (1d4 + 2) bludgeoning damage

## Guard Captain
**HP:** 15
**Action:** Wooden Club: +4 to hit, 5 (1d4 + 3) bludgeoning damage
...
## Guard Brute
**HP:** 20
**Saving Throws:** STR +4, DEX +0, CON -1, INT -1, WIS +0, CHA +0
**Action:** Fists: +4 to hit, 5 (1d4 + 3) bludgeoning damage

### Varthis the Cursed (statblock).md
